...
let drink = 'water';
let myName = "Matt";
let myFriendsName = "Steve";

console.log(food,drink,myName,myFriendsName);

//Question: Name a reason why you would use const instead of let.
//Answer: const variables will remain constant and will never change, 
//unlike let which will change if a different value is placed in curly brackets.
 ...
 * ↓ YOUR CODE HERE ↓ */
console.log(
`My friend ${myFriendsName} and me, ${myName}, are drinking ${drink} while eating a ${food}.`);
...
//Answer: 
//console.log("My friend + {myFriendsName} and me, + {myName}, are drinking {drink} while eating a {food}.");
console.log(`-------------------------- 
Question 2a: Oh no`)
...
//Answer: Because the variable is a const or constant it cannot be switched.
 ...
 * ↓ YOUR CODE HERE ↓ */
let lunchTime = (foodChoice, drinkChoice) => {return `My friend ${myFriendsName} and me, ${myName}, are drinking ${drink} while eating a ${food}.`}
...
{return `${callbackFunction} Tomorrow we want ${tomorrowsFoodChoice} and we will have ${tomorrowsDrinkChoice} to drink.`}

console.log(foodForTodayAndTomorrow('Pizza','soda', lunchTime ('salad','juice')));
